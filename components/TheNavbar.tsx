...
const TheNavbar = () => {
  ...
  return (
    <nav className='md:bg-gray-main rounded w-full justify-center lg:p-layout-p md:p-3 flex md:flex-col md:gap-5 gap-[clamp(1rem,12vw,6rem)] md:shadow h-[64px] md:h-[initial] items-center'>
      {routes.map((route) => (
        <NavbarItem
