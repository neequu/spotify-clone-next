...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    <SliderPrimitive.Thumb className='block opacity-0 group-hover:opacity-100 h-3 w-3 rounded-full bg-white  transition focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 ' />
  </SliderPrimitive.Root>
));
