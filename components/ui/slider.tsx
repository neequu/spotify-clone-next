...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    <SliderPrimitive.Thumb className='block group-hover:opacity-100 h-[10px] w-[10px] rounded-full bg-white  transition focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 ' />
  </SliderPrimitive.Root>
));
