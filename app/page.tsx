...
export default function Home() {
  return (
    <div className='flex-1 flex flex-col rounded overflow-hidden bg-gray-main md:bg-gradient-to-b from-accent-dark from-[40px] via-[#30705599] via-[100px]  to-gray-main to-[196px]'>
      <TheHeader />
