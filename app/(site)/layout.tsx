...
export default async function RootLayout({
  ...
  return (
    <body
      className={`${font.className} flex min-h-screen min-w-[250px] select-none flex-col justify-between gap-2 overflow-hidden bg-gray-main text-white md:flex-row md:bg-gray-bg md:px-2`}
    >
      <ToastProvider />
      <ModalProvider />
