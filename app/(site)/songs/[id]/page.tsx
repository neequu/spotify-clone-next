...
const page = async ({ params }: { params: { id: string } }) => {
  ...
  return (
    <>
      <main className="gradient-dark h-screen overflow-hidden">
        ...
        <section className="mt-2 flex h-[56vh] overflow-auto px-2 pb-[52px] text-base md:mt-4 md:h-[62.8vh] md:px-4">
          <Suspense
            fallback={
